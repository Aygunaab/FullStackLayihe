    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSpecsifications", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BannerCoverImage = table.Column<string>(maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(nullable: false),
                    DiscountPrice = table.Column<decimal>(nullable: true),
                    Avability = table.Column<string>(nullable: false),
                    LabelId = table.Column<int>(nullable: true),
                    IsPopularCategory = table.Column<bool>(nullable: false),
                    IsBestSeellers = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mesage = table.Column<string>(maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSocials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductSocials_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSocials_Socials_SocialId",
                        column: x => x.SocialId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSocials_ProductId",
                table: "ProductSocials",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSocials_SocialId",
                table: "ProductSocials",
                column: "SocialId");
        }
